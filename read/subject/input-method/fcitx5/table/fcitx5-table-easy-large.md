...
| 微調腳本 | 中文輸入法 |
| -------- | ---------- |
| [fcitx5-table-easy-large 安裝設定腳本](https://github.com/samwhelp/anduinos-adjustment/tree/main/prototype/main/im-config/fcitx5/fcitx5-table-easy-large) | 輕鬆輸入法 |
...
> 可以參考我的「[package-list.txt](https://github.com/samwhelp/anduinos-adjustment/blob/main/prototype/main/im-config/fcitx5/fcitx5-chewing/package-list.txt)」
